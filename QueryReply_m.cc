...
void QueryReply::copy(const QueryReply& other)
{
    ...
    this->querySendStamp_var = other.querySendStamp_var;
}
...
void QueryReply::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->querySendStamp_var);
}
...
void QueryReply::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->querySendStamp_var);
}
...
simtime_t QueryReply::getQuerySendStamp() const
{
    return querySendStamp_var;
}

void QueryReply::setQuerySendStamp(simtime_t querySendStamp)
{
    this->querySendStamp_var = querySendStamp;
}
...
int QueryReplyDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='q' && strcmp(fieldName, "querySendStamp")==0) return base+2;
...
std::string QueryReplyDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return double2string(pp->getQuerySendStamp());
        default: return "";
    }
}
...
bool QueryReplyDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setQuerySendStamp(string2double(value)); return true;
